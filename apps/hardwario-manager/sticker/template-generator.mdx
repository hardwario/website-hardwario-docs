...
- **Alarm rules** are encoded into the same 17-byte packed slots used by the [**Downlink Commands Generator**](/sticker/connectivity/downlink-commands-generator) and the `alarm` shell command; here you build them with the rule editor instead of pasting hex.
:::
