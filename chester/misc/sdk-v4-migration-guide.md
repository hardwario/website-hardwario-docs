...
Delete any existing `build` directory and rebuild from scratch, because sysbuild changes the build layout, so an incremental build on top of an NCS v2.9 tree will not work.
