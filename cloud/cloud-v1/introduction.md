...
<Image img={require('./images/hardwario-cloud.png')} alt="Diagram: CHESTER connects to HARDWARIO Cloud over LTE-M/NB-IoT/LoRaWAN; data flows via webhook and REST API to integrations"/><br/>
