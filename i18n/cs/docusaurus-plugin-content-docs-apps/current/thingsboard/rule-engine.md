...
Při vytvoření instance nebo tenanta ThingsBoard se automaticky vygeneruje **Root Rule Chain**. Ta funguje jako hlavní vstupní brána: **každá jednotlivá zpráva z každého zařízení prochází nejprve tímto řetězcem**.

### Na co si dát pozor {#what-to-be-careful-about}

1. **Nikdy nemažte uzly „Save Timeseries“ a „Save Client Attributes“:** Tyto uzly zajišťují vlastní zápis dat ze senzorů do databáze ThingsBoard. Pokud je omylem smažete nebo přerušíte cestu k nim, vaše zařízení budou vypadat online, ale **na dashboardech se neobjeví žádná data**, protože se neukládají!
