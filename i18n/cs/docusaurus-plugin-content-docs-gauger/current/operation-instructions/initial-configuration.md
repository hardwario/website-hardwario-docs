...
| Režim Wi-Fi                   | `wifi.enabled`                | Bool    | true            | Pokud true, Wi-Fi je zapnutá                        |
| Režim Wi-Fi                   | `wifi.station`                | Bool    | false           | Pokud true, Wi-Fi je v režimu station, jinak AP     |
| Stav DHCP serveru Wi-Fi       | `wifi.net.dhcp`               | Bool    | true            | Pokud true, DHCP Wi-Fi je zapnuté                   |
