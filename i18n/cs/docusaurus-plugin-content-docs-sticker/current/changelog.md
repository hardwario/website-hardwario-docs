...
- **[FW]** Příznak kalibrace se maže na začátku inicializace kalibrace — běh je jednorázový (po 2hodinové lhůtě nebo dřívějším resetu se zařízení vrací k normálnímu OTAA)
...
- **[FW]** Atomický snapshot a vymazání příznaků notifikací při compose — brání souběhům
