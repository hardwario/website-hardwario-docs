...
description: "Zařízení HARDWARIO STICKER podporuje několik bezdrátových komunikačních protokolů, takže si můžete vybrat rádiovou architekturu optimální pro vaše nasazení."
---
import Image from '@theme/IdealImage';

# Přehled konektivity {#connectivity-overview}

Zařízení HARDWARIO STICKER podporuje několik bezdrátových komunikačních protokolů, takže si můžete vybrat rádiovou architekturu optimální pro vaše nasazení.

:::tip Zprovoznění a režim rádia
Bez ohledu na zvolený protokol konektivity lze stav rádia i přihlašovací údaje nastavit bezdrátově přes NFC v aplikaci [**HARDWARIO Manager**](../hardwario-manager.md).
:::
