...
- **Validace při startu:** Po vložení baterií zařízení STICKER nabootuje, ověří čekající konfiguraci uloženou v EEPROM NFC, aplikuje parametry a spustí normální provoz.
