...
<div class="container">
  <div class="row">
    <div class="col col--4">
      <div><Image img={require('../../../../../tower/hardware-modules/images/button-module.png')} alt="Čelní panel modulu Button Module s jedním velkým kulatým tlačítkem" /></div>
    </div>
    <div class="col col--6">
      <p>
...
- [**Zdrojový soubor**](https://github.com/hardwario/twr-sdk/blob/master/twr/src/twr_button.c)
- [**Projekty**](https://www.hackster.io/hardwario/projects?part_id=73683)
