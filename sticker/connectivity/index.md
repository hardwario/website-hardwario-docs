...
Regardless of the chosen connectivity protocol, radio state and credentials can be configured wirelessly over NFC using [**HARDWARIO Manager**](../hardwario-manager).
:::
...
- **[ChirpStack v4 Integration](./lorawan-chirpstack)** — Setup guide for self-hosted ChirpStack LNS deployments.
- **[The Things Stack Integration](./lorawan-tts)** — Setup guide for TTS Cloud and Community Edition.
- **[Downlink Commands](./downlink-commands)** — Reference guide for remote parameters configuration over fPort 85.
...
- **[LoRa P2P Guide](./lora-p2p)** — Architecture overview, RF framing parameters, and edge gateway integration.