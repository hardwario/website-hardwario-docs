...
<Image img={require('./images/blockly-showcase.png')} alt="HARDWARIO Blockly workspace with initialization blocks and event blocks publishing data over the radio" />
...
<Image img={require('./images/blockly-code.png')} alt="Blockly workspace with Show Code enabled: the generated C code appears next to the blocks" />
