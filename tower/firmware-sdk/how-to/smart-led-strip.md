...
LEDs featured [**on our strip**](https://www.hardwario.store/p/led-strip-rgbw-1m) are RGBW. This means they include a separate light source for **Red**, **Green**, **Blue** and **White** (warm white) colors.
